...
class KISA_SEED_INFO {
	...
	function __construct() {
		$this->ctr = array_pad(array(), 4, 0);//ivec -> ctr 수정
...
class KISA_SEED_CTR {
	...
	*/
	...
	{	
		...
		$pInfo->encrypt = $enc;
		Common::memcpy_byte2int($pInfo->ctr, $pbszCTR, 16);//ivec -> ctr 수정
	...
	//	$pdwCounter_offset = 0;
		...
		$pdwCounter = &$pInfo->ctr; //ivec -> ctr 수정
		//$in_offset = 0;			삭제
		//$out_offset = 0;			삭제
		//$pbszCounter_offset = 0;  삭제
		//$pdwCounter_offset = 0;   삭제
		...
		//	$pbszCounter_offset = $pdwCounter_offset; //삭제
			...
			$in_offset += KISA_SEED_CTR::BLOCK_SIZE_CTR_INT;//수정
			$out_offset += KISA_SEED_CTR::BLOCK_SIZE_CTR_INT;//수정
		}
