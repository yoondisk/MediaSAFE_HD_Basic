...
reff = Request.ServerVariables("HTTP_HOST") & Request.ServerVariables("URL")

if (Request.QueryString("rtsp")=1) Then
	'rtsp
...
<link rel="stylesheet" href="css/plyr.css?v=<%=ConvertToUnixTimeStamp()%>" />
...
.list_subtitle .li_name p{display:block; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; font-weight:normal; padding-left:5px; }
  ...
  <body> 
	...
	<script src="js/plyr.js?v=<%=ConvertToUnixTimeStamp()%>" ></script>
	<script src="js/util.js?v=<%=ConvertToUnixTimeStamp()%>" ></script>
	...
	*/
	...
	var vod_qt = 0;
			...
			function get_json(a,b,c,d,e){
			   ...
			   smi_load=1;
				 $('.ls_c_textarea').html('');
				 $.getJSON('json_1080.asp?v=20200524', function(data) {
					var html = '';
