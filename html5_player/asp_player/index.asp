...
<link href="css/video-js.css?<%=ConvertToUnixTimeStamp()%>" rel="stylesheet">
...
<!-- JS code -->
<script src="js/video.js?<%=ConvertToUnixTimeStamp()%>"></script>
<script src="js/util.js?<%=ConvertToUnixTimeStamp()%>"></script>
