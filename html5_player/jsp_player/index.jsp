...
String reff=request.getServerName()+request.getRequestURI();
String org_rtsp_url="";
String encstring="";

if (request.getParameter("rtsp")!=null && Integer.parseInt(request.getParameter("rtsp"))==1) {
	//rtsp
	...
	encstring = encrypt(bszIV,bszUser_key, org_rtsp_url)+".mp4";
}

Integer intUnixTime = (int)((long) System.currentTimeMillis()/1000) ;
String nocache= Integer.toString(intUnixTime);
...
<link rel="stylesheet" href="css/plyr.css?v=<%=nocache%>" />
...
.list_subtitle .li_name p{display:block; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; font-weight:normal; padding-left:5px; }
  ...
  <body> 
	...
	<script src="js/plyr.js?v=<%=nocache%>" ></script>
	<script src="js/util.js?v=<%=nocache%>" ></script>
	...
	var install_app_url="MediaSafe.deb";
	...
	*/
	...
	var vod_qt = 0;
			...
			function get_json(a,b,c,d,e){
			   ...
			   smi_load=1;
				 $('.ls_c_textarea').html('');
				 $.getJSON('json_1080.jsp?v=20200524', function(data) {
					var html = '';
